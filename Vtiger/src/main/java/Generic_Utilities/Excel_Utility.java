...
public class Excel_Utility {
	...
	{
		 FileInputStream fis2 = new FileInputStream("./src/test/resources/Product1.xlsx");
	...
	{
		FileInputStream fis = new FileInputStream("./src/test/resources/Product1.xlsx");
		Workbook book = WorkbookFactory.create(fis);
		Sheet sheet = book.getSheet(sheetName);
		Row row = sheet.createRow(rowNum);
		Cell cell = row.createCell(cellNum);
		cell.setCellValue(data);
		FileOutputStream fos = new FileOutputStream("./src/test/resources/Product1.xlsx");
		book.write(fos);
		book.close();
